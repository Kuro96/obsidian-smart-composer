...
export function RAGSection({ app, plugin }: RAGSectionProps) {
  ...
  return (
    <div className="smtcmp-settings-section">
      <div className="smtcmp-settings-header">Vault Chat</div>

      <ObsidianSetting
        name="Enable Vault Chat"
        desc="Use embeddings and retrieval to chat with relevant content from your vault."
      >
        <ObsidianToggle
          value={settings.vaultChatEnabled}
          onChange={async (value) => {
            await setSettings({
              ...settings,
              vaultChatEnabled: value,
            })
          }}
        />
      </ObsidianSetting>

      {!settings.vaultChatEnabled ? null : (
        <>
          ...
          <ObsidianSetting
            ...
            desc="Maximum number of tokens before switching to retrieval for mentioned files. If the total tokens exceed this, Vault Chat will retrieve relevant snippets instead of including every file in full."
          >
            <ObsidianTextInput
          ...
          <ObsidianSetting
            ...
            desc="Minimum similarity score for retrieval results. Higher values return more relevant but potentially fewer results."
          >
            <ObsidianTextInput
          ...
          <ObsidianSetting
            name="Limit"
            desc="Maximum number of retrieval results to include in the prompt. Higher values provide more context but increase token usage."
          >
            <ObsidianTextInput
